...
# We're interested in bracket trees that contain "not" or "n't" followed by "and"
match_pattern = r"\bn[o']?t\b.*?\band\b"
...
results.drop(columns=['match']).to_csv('1_results_not_and.csv', index=False)
summary.to_csv('1_summary_not_and.csv', index=False)
